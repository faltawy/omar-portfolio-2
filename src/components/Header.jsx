...
export function ContactMe({ bg }) {
    return (<button onClick={() => { window.scrollTo(0, document.body.scrollHeight) }} className={`flex items-center gap-1 text-white ${bg ? 'bg-neutral-500' : 'bg-transparent'} px-2 py-1 font-bold`}>
