...
function Overlay({ image_url, toggle, expanded }) {
    return (
        <div className={`fixed animate-in animate-out fade-in-30 z-[500] h-screen w-screen min-h-0 inset-0 bg-opacity-50 items-center bg-gray-700 justify-center ${!expanded ? 'hidden' : 'flex'}`}>
